...
Install-DbaMaintenanceSolution -sqlinstance $Targets  @olaParams | Out-Null
...
Install-DbaFirstResponderKit -sqlinstance $Targets  -Database $FirstResponderDB | Out-Null
...
Install-DbaWhoIsActive -SqlInstance $SqlInstance  -Database $SPWhoisactiveDB | Out-Null
...
Invoke-DbaQuery -sqlinstance $Targets  -database msdb -Query sp_update_job -SqlParameter @{ job_name = "_MAINT_DatabaseBackup - USER_DATABASES - FULL"; enabled = $UserFULLBackups} -CommandType StoredProcedure
Invoke-DbaQuery -sqlinstance $Targets  -database msdb -Query sp_update_job -SqlParameter @{ job_name = "_MAINT_DatabaseBackup - USER_DATABASES - DIFF"; enabled = $UserDIFFBackups} -CommandType StoredProcedure
Invoke-DbaQuery -sqlinstance $Targets  -database msdb -Query sp_update_job -SqlParameter @{ job_name = "_MAINT_DatabaseBackup - USER_DATABASES - LOG"; enabled = $UserLOGBackups} -CommandType StoredProcedure
Invoke-DbaQuery -sqlinstance $Targets  -database msdb -Query sp_update_job -SqlParameter @{ job_name = "_MAINT_DatabaseBackup - SYSTEM_DATABASES - FULL"; enabled = $SystemFULLBackups} -CommandType StoredProcedure
Invoke-DbaQuery -sqlinstance $Targets  -database msdb -Query sp_update_job -SqlParameter @{ job_name = "_MAINT_DatabaseIntegritycheck - SYSTEM_DATABASES"; enabled = $SystemIntegrity} -CommandType StoredProcedure
Invoke-DbaQuery -sqlinstance $Targets  -database msdb -Query sp_update_job -SqlParameter @{ job_name = "_MAINT_DatabaseIntegritycheck - USER_DATABASES"; enabled = $UserIntegrity} -CommandType StoredProcedure
Invoke-DbaQuery -sqlinstance $Targets  -database msdb -Query sp_update_job -SqlParameter @{ job_name = "_MAINT_IndexOptimize - USER_DATABASES"; enabled = $indexOptimize} -CommandType StoredProcedure
Invoke-DbaQuery -sqlinstance $Targets  -database msdb -Query sp_update_job -SqlParameter @{ job_name = "_MAINT_CommandLog Cleanup"; enabled = $CommandLogCleanup} -CommandType StoredProcedure
Invoke-DbaQuery -sqlinstance $Targets  -database msdb -Query sp_update_job -SqlParameter @{ job_name = "_MAINT_CycleErrorLog"; enabled = $CycleErrorLog} -CommandType StoredProcedure
Invoke-DbaQuery -sqlinstance $Targets  -database msdb -Query sp_update_job -SqlParameter @{ job_name = "_MAINT_Output File Cleanup"; enabled = $OutputFileCleanup} -CommandType StoredProcedure
Invoke-DbaQuery -sqlinstance $Targets  -database msdb -Query sp_update_job -SqlParameter @{ job_name = "_MAINT_sp_delete_backuphistory"; enabled = $DeleteBackupHistory} -CommandType StoredProcedure
Invoke-DbaQuery -sqlinstance $Targets  -database msdb -Query sp_update_job -SqlParameter @{ job_name = "_MAINT_sp_purge_jobhistory"; enabled = $PurgeJobHistory} -CommandType StoredProcedure
Invoke-DbaQuery -sqlinstance $Targets  -database msdb -Query sp_update_job -SqlParameter @{ job_name = "_MAINT_sp_whoisactive data collection monitoring"; enabled = $Whoisactive} -CommandType StoredProcedure
