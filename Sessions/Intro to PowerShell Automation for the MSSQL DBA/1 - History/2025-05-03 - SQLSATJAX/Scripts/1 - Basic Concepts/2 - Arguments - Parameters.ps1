...
Invoke-dbaquery -SqlInstance "Localhost" -File "C:\Users\DavidSeis\Documents\Git\Presentations\Sessions\Intro to PowerShell Automation for the MSSQL DBA\2025-05-03 - SQLSATJAX\Scripts\1 - Basic Concepts\basics.sql" 